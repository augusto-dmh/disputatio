...
1. [ ] Scaffold: `pnpm create tauri-app` (react-ts), pnpm + Biome + Vitest + Tailwind 4 wiring, `.nvmrc`, `make dev` target, CI rust/frontend jobs + dependabot cargo/npm activated (ADR 0009)
